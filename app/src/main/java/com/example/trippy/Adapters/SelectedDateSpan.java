 ...
 */
class SelectedDateSpan implements LineBackgroundSpan {
     ...
     *
     * @see #SelectedDateSpan(float, int)
     * @see #DEFAULT_RADIUS
     */
    public SelectedDateSpan() {
     ...
     * @see #DEFAULT_RADIUS
     */
    public SelectedDateSpan(int color) {
        this.radius = DEFAULT_RADIUS;
        this.color = color;
    }
     ...
     * @see #SelectedDateSpan(float, int)
     */
    public SelectedDateSpan(float radius) {
        this.radius = radius;
        this.color = 0;
    }
     ...
     * @param color  color of the dot
     */
    public SelectedDateSpan(float radius, int color) {
        this.radius = radius;
        this.color = color;
    }
